...
<UserOutlined style="font-size:2rem;" @click="showDrawer"/>
  ...
  >
    ...
    <div class="logout">
     ...
     <a-modal centered="true" v-model:visible="registerModalVisible" width="20%" :footer="null" title="注册">
    ...
    <a-modal centered="true" v-model:visible="loginModalVisible" width="20%" :footer="null" title="登录">
...
export default defineComponent({
  ...
  setup() {
    ...
    const userRegister = () => {
      ...
      global.$store.dispatch('user/register', registerForm).then(()=>{
    ...
    const userLogin = () => {
      ...
      global.$store.dispatch('user/login', loginForm).then(()=>{
