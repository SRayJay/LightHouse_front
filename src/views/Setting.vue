      ...
      <a-tab-pane key="1" tab="个人信息" class="flex flex-column">
        <div class="flex flex-row flex-vcenter mb20">
          ...
          <div class="nameBar flex flex-row mb20 flex-vcenter">
            ...
            <a-input style="width:20%;" size="large" v-model.value="userName" class="nameInput" maxlength="10" @blur="checkName" /></div>
          <div class="sexBar mb20 flex flex-row flex-vcenter">
            <div class="mtitle">性别</div>
            <div class="sex_radio">
              <a-radio-group v-model:value="userSex[1]">
                <a-radio :label="1">男</a-radio>
                <a-radio :label="0">女</a-radio>
              </a-radio-group>
          ...
          <div class="selflabelBar mb20 flex flex-row flex-vcenter">
            ...
            <a-input style="width:20%;" size="large" v-model.value="signature" class="selfLabelInput" />
          </div>
